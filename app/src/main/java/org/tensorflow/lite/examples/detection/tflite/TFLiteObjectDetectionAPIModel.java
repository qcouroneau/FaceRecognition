...
public class TFLiteObjectDetectionAPIModel
    ...
    private static final String FILE_NAME = "classes";
    ...
    public void register(String name, Recognition rec, DetectorActivity det) {
        ...
        try {
            Gson gson = new Gson();
            SharedPreferences sharedPref = det.getSharedPreferences("Shared Preferences", 0);
            SharedPreferences.Editor editor = sharedPref.edit();

            Type type = new TypeToken<HashMap<String, Recognition>>() {
            }.getType();
            String json = gson.toJson(registered, type);
    ...
    public static SimilarityClassifier create(
            ...
            HashMap<String, Recognition> registered)
            throws IOException {
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap, boolean storeExtra) {
        ...
        try {
            if (registered.size() > 0 && !lock.isLocked()) {
